...
const skills = [
  ...
  { name: 'MERN Stack Development', level: 86, icon: 'fas fa-layer-group', color: '#00d2ff' },
  { name: 'Python', level: 86, icon: 'fab fa-python', color: '#3776ab' },
  { name: 'C++', level: 86, icon: 'fas fa-code', color: '#00599c' },
  { name: 'HTML5', level: 86, icon: 'fab fa-html5', color: '#e34f26' },
  { name: 'CSS3', level: 86, icon: 'fab fa-css3-alt', color: '#1572b6' },
  { name: 'JavaScript', level: 86, icon: 'fab fa-js', color: '#f7df1e' },
